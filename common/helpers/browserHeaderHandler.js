class browserHeaderHandler {
    ...
    async _getdom() {
        ...
        const domStr = `
        <div class="xly__left__icons">
                <svg t="1625133230776" class="xly__arrow xly__arrow__left" viewBox="0 0 1024 1024" version="1.1"
                ...
                <svg t="1625133230776" class="xly__arrow xly__arrow__right" viewBox="0 0 1024 1024" version="1.1"
                    xmlns="http://www.w3.org/2000/svg" p-id="8518" width="20" height="20">
                    <path
                        d="M439.253333 841.216a42.666667 42.666667 0 0 0 59.904-60.8L270.08 554.666667h583.253333a42.666667 42.666667 0 1 0 0-85.333334H270.336L499.2 243.84a42.666667 42.666667 0 0 0-59.904-60.8l-295.424 291.114667a53.333333 53.333333 0 0 0 0 75.946666l295.424 291.114667z"
                        p-id="8519"></path>
                ...
                <svg t="1625133882193" class="xly__refresh" viewBox="0 0 1024 1024" version="1.1"
                ...
                <svg t="1625188608986" class="xly__home" viewBox="0 0 1024 1024" version="1.1"
            ...
            <div class="xly__center__link">
                <div class="xly__left">
                    <svg t="1625189216066" class="xly__lock" viewBox="0 0 1024 1024" version="1.1"
                    ...
                    <span class="xly__link">${showUrl}</span>
                </div>
                <div class="xly__right">
                    <svg t="1625191226947" class="xly__star" viewBox="0 0 1024 1024" version="1.1"
            ...
            <div class="xly__right__icons">
                <div class="xly__user">
                    <svg t="1625191809187" class="xly__user__icon" viewBox="0 0 1024 1024" version="1.1"
                ...
                <svg t="1625191989245" class="xly__more" viewBox="0 0 1024 1024" version="1.1"
    ...
    _getStyle() {
        ...
        .xly__browser__header>.xly__center__link {
            flex: 1 0 auto;
        ...
        .xly__browser__header>.xly__right__icons {
            margin-left: 12px;
            display: flex;
            align-items: center;
        }
    
        .xly__left__icons>.xly__arrow {
            fill: #BABCBE;
        }
    
        .xly__left__icons>.xly__arrow.xly__arrow.xly__arrow__left {
            margin-right: 6px;
        }
    
        .xly__left__icons>.xly__arrow.xly__arrow__right {
            transform: rotate(180deg);
        }
    
        .xly__left__icons>.xly__refresh {
            fill: #5F6368;
            margin-left: 8px;
        }
    
        .xly__left__icons>.xly__home {
            margin-left: 10px;
            margin-right: 12px;
        }
    
        .xly__center__link>.xly__left>.xly__lock {
            fill: #626365;
            margin-left: 12px;
            margin-right: 8px;
        }
    
        .xly__center__link>.xly__left>.xly__link {
            font-size: 14px;
            color: #202124;
        }
    
        .xly__center__link>.xly__right {
            display: flex;
            align-items: center;
        }
    
        .xly__center__link>.xly__right>.xly__star {
            fill: #444444;
            margin-right: 10px;
        }
    
        .xly__right__icons>.xly__user {
            height: 24px;
            width: 24px;
            border-radius: 50%;
        ...
        .xly__right__icons>.xly__user>.xly__user__icon {
            fill: #555F70;
        }`
        return styleStr;
    }
    ...
    async addHeader() {
        const header = await this.page.$('.xly__browser__header');
        if (!!header) {
        ...
        await this.page.evaluate((template) => {
            ...
            stylee.classList.add('xly__browser__header__style');
            stylee.innerHTML = template.style;
            document.body.insertBefore(stylee, document.body.firstChild);

            let div = document.createElement('div');
            div.classList.add('xly__browser__header');
            div.innerHTML = template.dom;
            document.body.insertBefore(div, document.body.firstChild);
        }, template);
        try {
            await this.page.waitForSelector('.xly__browser__header', {
                timeout: 30000,
                visible: true
            })
        } catch (error) {
    ...
    async removeHeader() {
        ...
        if (!!header) {
            await this.page.evaluate(() => {
                const header = document.querySelector('.xly__browser__header');
                header.remove();
                const stylee = document.querySelector('.xly__browser__header__style');
                stylee.remove();
            })
            try {
