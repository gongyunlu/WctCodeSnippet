...
const DoublyLinkedList = require('../dataModels/DoublyLinkedList');
...
/**
 * 序列化双向链表
 * @param {DoublyLinkedList} linkedList 双向链表
 */
function serializeLinkedList(linkedList) {
    let array = [];
...
/**
 * 反序列化双向链表
 * @param {Array} array 链表数据集合
 */
function deserializeLinkedList(array) {
